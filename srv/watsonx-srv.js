...
module.exports = function () {
    this.on('classifyInput', async (req) => {
        ...
        try {
            ...
            const classifyResult = await axios.post(urlClassify, { input: req?.data?.desc }, paramsClassify);
            console.info(classifyResult);

            return classifyResult?.data?.results[0]?.generated_text;
        } catch (e) {
